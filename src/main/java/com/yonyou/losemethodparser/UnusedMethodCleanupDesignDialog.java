...
public class UnusedMethodCleanupDesignDialog extends DialogWrapper {
    ...
    private JCheckBox remoteCallCheckBox;
    ...
    protected JComponent createCenterPanel() {
        ...
        remoteCallCheckBox = new JCheckBox("RemoteCall");
        ...
        remoteCallCheckBox.setSelected(true);
        ...
        excludeScopePanel.add(modelCheckBox);
        excludeScopePanel.add(remoteCallCheckBox);
    ...
    protected JComponent createSouthPanel() {
        ...
        parseButton.addActionListener(e -> {
            ...
            try {
                java.util.List<String> excludedScopes = getExcludedScopes(controllerCheckBox, dtoCheckBox, enumCheckBox, testCheckBox, deprecatedCheckBox, resourceCheckBox, modelCheckBox, remoteCallCheckBox);
    ...
    private java.util.List<String> getExcludedScopes(JCheckBox controllerCheckBox, JCheckBox dtoCheckBox, JCheckBox enumCheckBox, JCheckBox testCheckBox, JCheckBox deprecatedCheckBox, JCheckBox resourceCheckBox, JCheckBox modelCheckBox, JCheckBox remoteCallCheckBox) {
        ...
        if (modelCheckBox.isSelected()) {
            excludedScopes.add("model");
        }
        if (remoteCallCheckBox.isSelected()) {
            excludedScopes.add("RemoteCall");
        }
